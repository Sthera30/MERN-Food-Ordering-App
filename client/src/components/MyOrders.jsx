...
function MyOrders() {
  ...
  async function handle_click(id) {
    ...
    try {
      ...
      const res = await axios.get(`https://mern-food-ordering-app-amkd.onrender.com/getAddressByOrder`, { params: { id } })
  ...
  async function handle_filte_status() {
    ...
    try {
      ...
      const res = await axios.get(`https://mern-food-ordering-app-amkd.onrender.com/filterStatus?status=${status}`)
  ...
  async function handle_price_filter() {
    ...
    try {
      ...
      const res = await axios.get(`https://mern-food-ordering-app-amkd.onrender.com/filterPrice?priceRange=${price}`)
  ...
  async function handle_filter() {
    ...
    try {
      ...
      const res = await axios.get(`https://mern-food-ordering-app-amkd.onrender.com/filterDate?startDate=${startDate}&endDate=${endDate}`)
