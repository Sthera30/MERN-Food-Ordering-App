...
import '../css/OurServiceSection.css'
...
function OurServices() {
    ...
    async function fetch_our_services() {
        ...
        try {
            ...
            const res = await axios.get('https://mern-food-ordering-backend-app.onrender.com/getOurServices')
    ...
    async function handle_delete(id) {
        ...
        try {
            ...
            const { data } = await axios.delete(`https://mern-food-ordering-backend-app.onrender.com/removeOurServices?id=${id}`)
