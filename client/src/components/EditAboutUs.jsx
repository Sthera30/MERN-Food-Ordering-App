...
function EditAboutUs() {
    ...
    async function handle_fetch_about_us_by_id(id) {
        ...
        try {
            ...
            const { data } = await axios.get(`https://mern-food-ordering-app-amkd.onrender.com/get_about_us_by_id?id=${id}`)
    ...
    async function handle_fetch_core_values_by_id(id) {
        ...
        try {
            ...
            const { data } = await axios.get(`https://mern-food-ordering-app-amkd.onrender.com/getCoreValuesById?id=${id}`)
    ...
    async function handle_fetch_vision_by_id(id) {
        ...
        try {
            ...
            const { data } = await axios.get(`https://mern-food-ordering-app-amkd.onrender.com/getVisionById?id=${id}`)
    ...
    async function handle_fetch_mission_by_id(id) {
        ...
        try {
            ...
            const { data } = await axios.get(`https://mern-food-ordering-app-amkd.onrender.com/getMissionById?id=${id}`)
    ...
    async function handle_edit_about_us(id) {
        ...
        try {
            ...
            const res = await axios.put(`https://mern-food-ordering-app-amkd.onrender.com/edit_about_us`, { id, aboutUsHeading, aboutUsDescription })
    ...
    async function handle_edit_mision(id) {
        ...
        try {
            ...
            const res = await axios.put(`https://mern-food-ordering-app-amkd.onrender.com/edit_mission`, { id, missionHeading, missionDescription })
    ...
    async function handle_edit_vision(id) {
        ...
        try {
            ...
            const res = await axios.put(`https://mern-food-ordering-app-amkd.onrender.com/edit_vision`, { id, visionHeading, visionDescription })
    ...
    async function handle_edit_values(id) {
        ...
        try {
            ...
            const res = await axios.put(`https://mern-food-ordering-app-amkd.onrender.com/edit_values`, { id, valuesHeading, valuesDescription })
