...
function AboutUs() {
    ...
    async function handle_fetch_about() {
        ...
        try {
            ...
            const res = await axios.get("https://mern-food-ordering-backend-app.onrender.com/getAboutUs")
    ...
    async function handle_fetch_mission() {
        ...
        try {
            ...
            const res = await axios.get("https://mern-food-ordering-backend-app.onrender.com/getMission")
    ...
    async function handle_fetch_vision() {
        ...
        try {
            ...
            const res = await axios.get("https://mern-food-ordering-backend-app.onrender.com/getVision")
    ...
    async function handle_fetch_core_values() {
        ...
        try {
            ...
            const res = await axios.get("https://mern-food-ordering-backend-app.onrender.com/getValues")
    ...
    async function handle_remove_about_us(id) {
        ...
        try {
            ...
            const res = await axios.delete(`https://mern-food-ordering-backend-app.onrender.com/remove_about_us?id=${id}`)
    ...
    async function handle_remove_mission(id) {
        ...
        try {
            ...
            const res = await axios.delete(`https://mern-food-ordering-backend-app.onrender.com/remove_mission?id=${id}`)
    ...
    async function handle_remove_vision(id) {
        ...
        try {
            ...
            const res = await axios.delete(`https://mern-food-ordering-backend-app.onrender.com/remove_vision?id=${id}`)
    ...
    async function handle_remove_values(id) {
        ...
        try {
            ...
            const res = await axios.delete(`https://mern-food-ordering-backend-app.onrender.com/remove_values?id=${id}`)
