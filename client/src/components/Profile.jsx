...
function Profile() {
    ...
    async function handle_submit(e) {
        ...
        try {
            ...
            const { data } = await axios.put('https://mern-food-ordering-app-amkd.onrender.com/updateProfile', { name, email, country, state, city, zipCode, profileImage, userId: user?.user?._id }, {
