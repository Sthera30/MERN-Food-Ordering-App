...
function EditFood() {
    ...
    async function handle_get_food_by_id(id) {
        ...
        try {
            ...
            const res = await axios.get(`https://mern-food-ordering-app-amkd.onrender.com/getFoodById?id=${id}`)
    ...
    async function handle_edit_food(e) {
        ...
        try {
            ...
            const res = await axios.put(`https://mern-food-ordering-app-amkd.onrender.com/edit_food`, { id, name, description, price, category, weight, foodImage, specificationName })
