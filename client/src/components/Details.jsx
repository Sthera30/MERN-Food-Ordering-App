...
function Details() {
    ...
    async function getFoodById() {
        ...
        try {
            const res = await axios.get(`https://mern-food-ordering-backend-app.onrender.com/getFoodById/${id}`)
    ...
    async function getSpecificationByProductId() {
        ...
        try {
            const res = await axios.get(`https://mern-food-ordering-backend-app.onrender.com/getSpecificationByProductId`, {
                params: { foodId }
            })
    ...
    async function getAllOrders() {
        ...
        try {
            ...
            const res = await axios.get("https://mern-food-ordering-backend-app.onrender.com/getAllOrders")
