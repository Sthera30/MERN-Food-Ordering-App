...
function ManageAboutUs() {
    ...
    async function handle_add_about_us() {
        ...
        try {
            ...
            const res = await axios.post(`https://mern-food-ordering-app-amkd.onrender.com/add_about_us`, { aboutUsHeading, aboutUsDescription, aboutUsImage })
    ...
    async function handle_add_mision() {
        ...
        try {
            ...
            const res = await axios.post(`https://mern-food-ordering-app-amkd.onrender.com/add_mission`, { missionHeading, missionDescription })
    ...
    async function handle_add_vision() {
        ...
        try {
            ...
            const res = await axios.post(`https://mern-food-ordering-app-amkd.onrender.com/add_vision`, { visionHeading, visionDescription })
    ...
    async function handle_add_values() {
        ...
        try {
            ...
            const res = await axios.post(`https://mern-food-ordering-app-amkd.onrender.com/add_values`, { valuesHeading, valuesDescription })
