...
function AddFood() {
    ...
    async function handle_onchange(e) {
        ...
        try {
            ...
            const response = await axios.post('https://mern-food-ordering-backend-app.onrender.com/upload', formData)
    ...
    async function handle_submit(e) {
        ...
        try {
            ...
            const { data } = await axios.post("https://mern-food-ordering-backend-app.onrender.com/add", { name, description, price, category, weight, foodImage, specificationName },
                {
                    headers: {
