...
function OurPromise() {
    ...
    async function fetch_promise() {
        ...
        try {
            ...
            const res = await axios.get(`https://mern-food-ordering-backend-app.onrender.com/getPromise`)
    ...
    async function remove_promise(id) {
        ...
        try {
            ...
            const { data } = await axios.delete(`https://mern-food-ordering-backend-app.onrender.com/removePromise?id=${id}`)
